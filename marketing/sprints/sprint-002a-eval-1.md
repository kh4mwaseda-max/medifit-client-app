...
| NEXT_PUBLIC_APP_URL | ✅ | `https://allyourfit.com` が設定済み |
...
| Vercel実際のデプロイ確認 | ❓ | コードからは判断不可。`https://allyourfit.com` が実際にアクセスできるか稲川さんがブラウザで確認する必要あり |
...
1. ブラウザで `https://allyourfit.com` を開く
   - 表示される → デプロイ済み ✅
